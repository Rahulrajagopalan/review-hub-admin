...
class _MoviesState extends State<Movies> {
  ...
  late final String _moviesCollection =
      'items'; // Replace with actual collection name
  ...
  Widget _buildMovieCard(QueryDocumentSnapshot<Map<String, dynamic>> movie) {
    ...
    if (movieData == null)
      return const SizedBox(); // Handle potential null data
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(name ?? 'No name',
                  style: TextStyle(
                      color: customBalck, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
      ),
